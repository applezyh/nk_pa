...
/* 0x80, 0x81, 0x83 */
make_group(gp1,
    EXW(add, 4),  EXW(or,1), EMPTY, EMPTY,
    EXW(and, 4), EXW(sub,4), EXW(xor, 4), EXW(cmp, 4))

  /* 0xc0, 0xc1, 0xd0, 0xd1, 0xd2, 0xd3 */
make_group(gp2,
    EMPTY, EMPTY, EMPTY, EMPTY,
    EXW(shl, 4), EXW(shr, 4), EMPTY, EXW(sar, 4))

  /* 0xf6, 0xf7 */
make_group(gp3,
    IDEXW(test_I,test,1), EMPTY, EXW(not, 4), EXW(neg,4),
    EXW(mul, 4), EXW(imul1, 4), EXW(div,4), EXW(idiv,4))
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x04 */	IDEXW(I2a, add, 1), IDEXW(I2a, add, 4), EX(push), EMPTY,
  ...
  /* 0x18 */	EMPTY, EMPTY, EMPTY, IDEXW(E2G, sbb, 4),
  /* 0x1c */	IDEXW(E2G, sbb, 1), IDEXW(E2G, sbb, 4), EMPTY, EMPTY,
  /* 0x20 */	EMPTY, EMPTY, IDEXW(E2G, and, 1), EMPTY,
  /* 0x24 */	EMPTY, IDEXW(I2a, and, 4), EMPTY, EMPTY,
  /* 0x28 */	EMPTY, IDEXW(G2E, sub, 4), EMPTY, IDEXW(E2G, sub, 4),
  /* 0x2c */	EMPTY, IDEXW(I2a, sub, 4), EMPTY, EMPTY,
  /* 0x30 */	EMPTY, IDEX(G2E, xor), EMPTY, EMPTY,
  /* 0x34 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x38 */	IDEXW(G2E, cmp, 1), IDEXW(G2E, cmp, 4), EMPTY, IDEXW(E2G, cmp, 4),
  /* 0x3c */	IDEXW(I2a, cmp, 1), IDEXW(I2a, cmp, 4), EX(nop), EMPTY,
  ...
  /* 0x88 */	IDEXW(mov_G2E, mov, 1), IDEXW(mov_G2E, mov, 4), IDEXW(mov_E2G, mov, 1), IDEXW(mov_E2G, mov, 4),
  ...
  /* 0xa8 */	IDEXW(I2a,test,1), IDEXW(I2a,test,4), EMPTY, EMPTY,
  ...
  /* 0xe8 */	IDEXW(I, call, 4), IDEXW(J, jmp, 4), IDEXW(J, jmp, 2), IDEXW(J, jmp, 1),
  ...
  /* 0x94 */	IDEXW(E, setcc, 1), IDEXW(E, setcc, 2), EMPTY, EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(Eb2G, mov, 4), IDEXW(Ew2G, mov, 4),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEXW(Eb2G, movsx, 4), IDEXW(Ew2G, movsx, 4),
