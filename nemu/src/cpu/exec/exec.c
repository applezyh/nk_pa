...
make_group(gp1,
    ...
    EXW(and, 4), EXW(sub,4), EMPTY, EXW(cmp, 4))
...
make_group(gp3,
    ...
    EXW(mul, 4), EXW(imul1, 4), EMPTY, EXW(idiv,4))
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x84 */	IDEXW(G2E, test, 2), IDEXW(E2G, test, 4), EMPTY, EMPTY,
  ...
  /* 0x84 */	IDEXW(J, jmp, 4), EMPTY, EMPTY, EMPTY,
  /* 0x88 */	IDEXW(J, jmp, 4), EMPTY, EMPTY, EMPTY,
