...
opcode_entry opcode_table [512] = {
  ...
  /* 0x48 */	EX(dec), EX(dec), EX(dec), EX(dec),
  /* 0x4c */	EX(dec), EX(dec), EX(dec), EX(dec),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_E2G, mov, 1), IDEXW(E2G, mov, 4),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEXW(E2G, mov, 1), IDEXW(E2G, mov, 4),
