...
opcode_entry opcode_table [512] = {
  ...
  /* 0x40 */	EX(inc), EMPTY, EMPTY, EX(inc),
  /* 0x44 */	EMPTY, EMPTY, EX(inc), EX(inc),
  /* 0x48 */	EMPTY, EMPTY, EMPTY, EX(dec),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(E2G, mov, 2), EMPTY,
