...
make_group(gp3,
  ...
  /* 0xfe */
make_group(gp4,
    EMPTY, IDEXW(r,dec, 1), EMPTY, EMPTY,
    EMPTY, EMPTY, EMPTY, EMPTY)
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x08 */	EMPTY, IDEXW(G2E, or, 4), EMPTY, IDEXW(E2G, or, 4),
  ...
  /* 0xfc */	EMPTY, EMPTY, IDEXW(r, gp4, 2), IDEX(E, gp5),
  ...
  /* 0x94 */	IDEXW(E, setcc, 2), IDEXW(E, setcc, 2), EMPTY, EMPTY,
