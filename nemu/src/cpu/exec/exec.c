...
opcode_entry opcode_table [512] = {
  ...
  /* 0x04 */	IDEXW(I2a, add, 1), IDEX(I2a, add), EX(push), EMPTY,
  ...
  /* 0x1c */	IDEXW(E2G, sbb, 1), IDEX(E2G, sbb), EMPTY, EMPTY,
  ...
  /* 0xe8 */	IDEX(I, call), IDEX(J, jmp), IDEXW(J, jmp, 2), IDEXW(J, jmp, 1),
  /* 0xec */	IDEXW(in_dx2a, in, 1), IDEX(in_dx2a, in), IDEXW(out_a2dx, out,1), IDEX(out_a2dx, out),
  /* 0xf0 */	EMPTY, EMPTY, EMPTY, EX(endbr),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(Eb2G, mov), IDEX(Ew2G, mov),
